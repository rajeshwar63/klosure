# Step 03 — Extraction rules

**Goal:** Document, in plain language, how Klo decides what to record from chat. This becomes part of the prompts in steps 04 and 05.

## Deliverable

A new markdown file: `supabase/functions/_shared/EXTRACTION_RULES.md`

This file is **referenced** by the prompts (the prompts will copy these rules verbatim into Klo's system prompt). Keeping it in a markdown file lets you iterate on the rules without redeploying — the prompt files import the text at build time.

## Content of EXTRACTION_RULES.md
...
- File created at `supabase/functions/_shared/EXTRACTION_RULES.md`
- File contains the markdown above verbatim
- Committed and pushed

→ Next: `04-bootstrap-prompt.md`
